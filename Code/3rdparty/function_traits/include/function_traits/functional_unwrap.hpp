...
namespace fu {
	...
	/// Trait which defines the argument types of the function packed in fu::identity.
	template <typename... Function>
	...
	template <typename... Function>
	using argument_tuple_type_of_t =
	typename detail::select_best_unwrap<Function...>::type::argument_tuple_type;
