...
\item[Hash table] In combination with the binary heap this data structure achieves approximately same throughput as WST (about 10\% lower). The concurrent version of this container has been introduced in this thesis (\Cref{sec:cndc}).
